# Generated by Django 5.1.6 on 2025-02-17 23:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('product_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='products.product')),
                ('type', models.CharField(choices=[('Wireguard', 'Wireguard'), ('OpenVPN', 'OpenVPN'), ('IKEV2', 'IKEV2'), ('L2TP', 'L2TP'), ('V2Ray', 'V2Ray'), ('SSH', 'SSH')], max_length=200)),
                ('duration', models.IntegerField(blank=True, default=30, help_text='Days')),
                ('limit', models.IntegerField(blank=True, default=0, help_text='GiB')),
